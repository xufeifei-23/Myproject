...
train_dir='data/ruijin_round1_train2_20181022'
test_dir='data/ruijin_round1_test_a_20181022'
train_file='data/example3.train'
dev_file='data/example3.dev'
